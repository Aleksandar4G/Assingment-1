...
<!-- Displays the data before you edit it -->
<p>
...
Daily Spendings :    <?php echo $row['dailyspendings']; ?><br> 
    <br>
    <!-- Button links so the user is able to edit the data -->
 <a class="btn btn-primary" href='update-work.php?id=<?php echo $row['id']; ?>'>Edit</a>
